...
const WhatsAppConfigDeleteModal = ({
  ...
  const handleDeleteConfig = async () => {
    await axios
      .delete(
        `${baseUrl}api/admin/client/config-profile/wa/delete-wa-profile/${openDeleteConfigModal.value.id}`,
        {
          headers: {
...
export default WhatsAppConfigDeleteModal;
