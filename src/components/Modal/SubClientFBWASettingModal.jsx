...
const SubClientFBWASettingModal = ({ setOpenConfigModal }) => {
  ...
  const handleCreateSubclientSMS = async () => {
    ...
    try {
      await axios
        .post(
          `${baseUrl}api/admin/sub-client/setting/facebook/wa-setting`,
  ...
  return (
    <div
      ...
      className="w-[90%] mx-auto lg:w-[500px] h-fit bg-blue-200 px-5 py-10 rounded-md"
    >
      <div className="flex items-center justify-between">
        <p className="text-gray-600 font-bold text-xl">
          Create New FB_WA Config
        </p>
        <button
          onClick={() => {
            setOpenConfigModal(false);
...
export default SubClientFBWASettingModal;
